...
@section('content')
    <div class="pb-3">
        ...
        <blockquote class="blockquote mb-0">
            <p>Sistem Pendukung Keputusan (SPK) ini dibangun untuk mendukung identifikasi kebutuhan pengamanan pada
                ...
                Untuk dapat menggunakan SPK ini, pengguna harus mengetahui Arsitektur Aplikasi. Ini meliputi basis data,
                sumber
                data, perangakt keras, dan jaringan tempat sistem elektronik terpasang.
            </p>

            <footer class="blockquote-footer">SPK ini merupakan bagian dari penelitian Mahasiswa S3 Fakultas Ilmu Komputer
                Universitas Indonesia</footer>
        </blockquote>
        <br>
        <div class="card">
            ...
            <div class="card-body">
                <ol>
                    ...
                    <li>
                        <h5>Pengguna Memilih sistem elektronik apa saja yang terhubung berdasarkan jenis keterhubungannya.
                            Jika
                            sistem
                    ...
                    <li>
                        <h5>Pengguna dapat juga memilih Sistem Ideal atau Sistem ISO. Sistem Ideal merupakan representasi
                            Peraturan
                            BSSN
                            tentang Kerangka Kerja Pelindungan Infrastruktur Informasi Vital. Sistem ISO merupakan
                            representasi ISO
                            27001:2022</h5>
                    </li>
                </ol>
