                ...
                <div class="card-body">
                    <form action="{{ $route }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="ref_tujuan_id">
                                @foreach (App\Models\RefTujuan::all() as $reftujuan)
                                    <option value="{{ $reftujuan->id }}" @selected($reftujuan->id === (old('tujuan_keamanan') ?? $reftujuan->tujuan_keamanan))>
                                        {{ $reftujuan->tujuan_keamanan }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="iiv_id">
                                @foreach (App\Models\IIV::all() as $sistem)
                                    <option value="{{ $sistem->id }}" @selected($sistem->id === (old('nama') ?? $sistem->nama))>
                                        {{ $sistem->nama }}
                                    </option>
                                @endforeach
                            </select>
