<nav class="navbar navbar-expand-lg">
    <div class="container">
        ...
        @auth
            @can('admin')
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="btn nav-link" data-bs-target="#staticBackdrop" data-bs-toggle="modal">
            ...
            @else
                <a class="navbar-brand logo" href="/">
                    <img sizes="32x32" src="{{ asset('dist/media/img/pakar-background.svg') }}" alt="aubna" />
                </a>
                <a class="navbar-brand logo scroller" href="index.html">
                    <img src="{{ asset('aubna') }}/assets/img/logo-fixed.png" alt="aubna" />
                </a>
        ...
        @else
            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a role="button" href="{{ route('login') }}" class="nav-link" data-bs-toggle="modal"
